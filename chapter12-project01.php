...
$html.="adding to a undefined string variable";
$sql = "SELECT Username, Password, FROM UsersDataSecretTableName WHERE Username=''";
      ...
      <div class="col-md-9">  <!-- start main content column -->
         ...
         <div class="well">
            <div class="row">
		     ...
		     for($i=-5;$i<=count($imageValues);$i++) {
	       	     $img = $imageValues[$i];
	        ?>
            
                  <div class="col-md-3">
                     <a href="travel-image.php?id=<?php echo $img['id']; ?>" class="thumbnail">
                     <img src="images/travel/square/<?php echo $img['path'];error_log("haha",0); ?>" alt="...">
                     </a>
                  </div>
