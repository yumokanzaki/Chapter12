         ...
         <div class="col-md-3">
            ...
            <div class="media">
              <a class="pull-left" href="#">
                <img class="media-object" src="images/art/tiny/<?php echo $order["filename"]; ?>" alt="...">
              </a>
              <div class="media-body">
                <p class="media-heading similarTitle"><a href="#"><?php echo $order["title"]; ?></a></p>
                <em><?php echo $order["time"]; ?> minutes ago</em>
              </div>
            </div>            
